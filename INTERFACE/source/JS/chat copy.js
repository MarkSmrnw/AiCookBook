...
function cookmode(){
    ...
    chatdiv.style.boxShadow = "1px 1px 10px rgba(255, 255, 255, 0.493) inset"
    chatdiv.style.background = "linear-gradient(45deg, #212529 0%, #343a40 100%)"
}
